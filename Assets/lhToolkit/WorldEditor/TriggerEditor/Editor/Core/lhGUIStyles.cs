...
namespace LaoHan.Tools.WorldEditor
{
    public class lhGUIStyles
    {
        ...
        lhGUIStyles()
        {
            ...
            lhGUIStyleSet styleSet = (lhGUIStyleSet)AssetDatabase.LoadAssetAtPath("Assets/lhToolkit/WorldEditor/TriggerEditor/Sources/CustomStyles.asset", typeof(lhGUIStyleSet));

...
public class UnityEngine_RigidbodyWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", _CreateUnityEngine_RigidbodyWrap);
	...
	static int _CreateUnityEngine_RigidbodyWrap(IntPtr L)
	{
		try
		{
	...
	static int SweepTest(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody), typeof(UnityEngine.Vector3), typeof(LaoHan.Infrastruture.ulua.LuaOut<UnityEngine.RaycastHit>)))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody), typeof(UnityEngine.Vector3), typeof(LaoHan.Infrastruture.ulua.LuaOut<UnityEngine.RaycastHit>), typeof(float)))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.RaycastHit arg1;
			...
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody), typeof(UnityEngine.Vector3), typeof(LaoHan.Infrastruture.ulua.LuaOut<UnityEngine.RaycastHit>), typeof(float), typeof(UnityEngine.QueryTriggerInteraction)))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.RaycastHit arg1;
